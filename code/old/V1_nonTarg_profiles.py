...
figDir = '/Users/joe/Documents/Olman_Lab/OriSeg/code/figs/nonTarg'
fig_format = 'png'
...
datasets = [#'/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/pnr102_V1_lh_target_laynii.csv',
   ...
   '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/nonTarg_filled/pnr328_V1_nonTarg_lh_rad10.csv',
   '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/nonTarg_filled/pnr328_V1_nonTarg_rh_rad10.csv',
   '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/nonTarg_filled/pnr510_V1_nonTarg_lh_rad10.csv',
   '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/nonTarg_filled/pnr739_V1_nonTarg_lh_rad10.csv',
   '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/nonTarg_filled/pnr739_V1_nonTarg_rh_rad10.csv',
   '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/nonTarg_filled/pnr756_V1_nonTarg_lh_rad10.csv',
   #'/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/nonTarg_filled/pnr756_V1_nonTarg_rh_rad10.csv'
  ]
datasets.sort()
...
for iR, label in enumerate(all_data.keys()):
    ...
    cov = np.cov(df['x'], df['y']) #spatial covariance
    com = (np.mean(df['x']), np.mean(df['y'])) #center of mass
    ...
    shft_x = df['x'] - com[0]
    shft_y = df['y'] - com[1]
    rot_x = shft_x*np.cos(theta) + shft_y*np.sin(theta) #x coord rotation
    rot_y = shft_x*np.sin(theta) - shft_y*np.cos(theta) #y coord rotation
    scl_x = rot_x/np.sqrt(a) # scale by sigma 
    scl_y = rot_y/np.sqrt(b)
    df['scale_xy_dist'] = np.sqrt(scl_x**2 + scl_y**2)
    
    scale_xy_dist = np.sqrt(scl_x**2 + scl_y**2)
    df['scale_xy_dist'] = scale_xy_dist
