...
datasets = [#'/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/pnr102_V1_lh_target_laynii.csv',
    #'/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data/pnr102_V1_rh_target_laynii.csv',
    '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr256_V1_tgt_lh_rad10.csv',
    '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr256_V1_tgt_rh_rad10.csv',
    '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr328_V1_tgt_lh_rad10.csv',
    '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr328_V1_tgt_rh_rad10.csv',
    '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr510_V1_tgt_lh_rad10.csv',
    '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr510_V1_tgt_rh_rad10.csv',
    '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr739_V1_tgt_lh_rad10.csv',
    '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr739_V1_tgt_rh_rad10.csv',
#   '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr756_V1_tgt_lh_rad10.csv',
    '/Users/joe/Documents/Olman_Lab/OriSeg/code/roi_data_manualSeg/target_filled/pnr756_V1_tgt_rh_rad10.csv'
  ]
datasets.sort()
...
[tmp , avgOtherDiffs] = compute_avg_depth_profile(depthProfiles,statDetails,diffDetails['statIDs'],taskStats,otherDiffs,use_decon,prop_err,useSI)
...
# context modulation contion. Plus, I will test all of the bins against all of 
...
for c_i, c in enumerate(avgTaskDiffs.keys()):
    ...
    pvals_lookup[c] = [cond_iter*nDepths,cond_iter*nDepths+nDepths]
    cond_iter += 1
...
pvals_task = {cond:all_pvals_dict[cond] for cond in avgTaskDiffs.keys()}
pvals_loc = {cond:all_pvals_dict[cond] for cond in avgLocDiffs.keys()}
...
xlim = [-1.5,2]
Ntext = [4,0.05]
plot_avg_diff_profile(p2,avgLocDiffs,['ctr-sur'],['coral'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,useSI,plot_indiv=diffProfiles,showSig=True,pthresh=pthresh,statCorrType=pvals_loc)
...
xlim = [-1.5,2]
Ntext = [4,0.05]
plot_avg_diff_profile(p2,avgTaskDiffs,['iso-sur'],['black'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,useSI,plot_indiv=diffProfiles,showSig=True,pthresh=pthresh,statCorrType=pvals_task)
...
xlim = [-1.5,2]
Ntext = [4,0.05]
plot_avg_diff_profile(p2,avgTaskDiffs,['fgm'],['magenta'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,useSI,plot_indiv=diffProfiles,showSig=True,pthresh=pthresh,statCorrType=pvals_task)
...
xlim = [-1.5,2]
Ntext = [4,0.05]
plot_avg_diff_profile(p2,avgTaskDiffs,['odss'],['green'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,useSI,plot_indiv=diffProfiles,showSig=True,pthresh=pthresh,statCorrType=pvals_task)
...
xlim = [-1.5,2]
Ntext = [4,0.05]
plot_avg_diff_profile(p2,avgTaskDiffs,['dsi'],['cyan'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,useSI,plot_indiv=diffProfiles,showSig=True,pthresh=pthresh,statCorrType=pvals_task)
