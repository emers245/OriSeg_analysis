...
if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt.png'))
...
if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt_iso0.png'))
...
if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt_iso90.png'))
...
if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt_orth.png'))
...
if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt_sur.png'))