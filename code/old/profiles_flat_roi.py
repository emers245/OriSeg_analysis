...
[hprofiles, hdiff, keep_depths, keep_rois, keep_std, fgm, odss, dSI] = plot_depth_profiles(all_data, roi_dict, statDetails, profile_method, nDepths, ['profiles','diff'],useSI,mask_dict,False)
