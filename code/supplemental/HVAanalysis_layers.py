...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V2/3','V1')
...
for c_i, c in enumerate(condition_list):
    ...
    top = avgV23Profiles[c]['avg'] + avgV23Profiles[c]['stdev']/np.sqrt(np.shape(avgV23Profiles[c]['avg'])[0])
    corrected_pvalues = multipletests(avgV23Profiles[c]['p-vals'].pvalue,method=statCorrType)[1]
    p_mat[c_i,:] = corrected_pvalues
    
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V1','V23')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V2/3 iso0','V1 iso0')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V1 iso0','V23 iso0')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V2/3 iso90','V1 iso90')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V1 iso90','V23 iso90')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V2/3 orth','V1 orth')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V1 orth','V23 orth')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V2/3 sur','V1 sur')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V1 sur','V23 sur')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V2/3 iso-sur','V1 iso-sur')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V1 iso-sur','V23 iso-sur')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V2/3 ODSS','V1 ODSS')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V1 ODSS','V23 ODSS')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V2/3 FGM','V1 FGM')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V1 FGM','V23 FGM')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V2/3 $\Delta$SI','V1 $\Delta$SI')
...
fig,ax = plot_gPPI_mat(data_mat,p_mat,'V1 $\Delta$SI','V23 $\Delta$SI')
