...
if savefigs:
    ...
    ftask.savefig(os.path.join(figDir,'pvals_task.'+figExt))
    ftask_hva.savefig(os.path.join(figDir,'pvals_task_hva.'+figExt))
...
if savefigs:
    fdhist.savefig(os.path.join(figDir,'depth_hist.'+figExt))
...
if savefigs:
    fdhist_hva.savefig(os.path.join(figDir,'depth_hist_hva.'+figExt))
...
if savefigs:
    fthresh.savefig(os.path.join(figDir,'mnv_hist.'+figExt))
    dmap.savefig(os.path.join(figDir,'mnv_depth_map.'+figExt))
    dmap_thresh.savefig(os.path.join(figDir,'mnv_depth_map_thresh.'+figExt))
    fdepth_hist.savefig(os.path.join(figDir,'mnv_depth_hist.'+figExt))
...
if savefigs:
    fthresh_hva.savefig(os.path.join(figDir,'mnv_hist_hva.'+figExt))
    dmap_hva.savefig(os.path.join(figDir,'mnv_depth_map_hva.'+figExt))
    dmap_thresh_hva.savefig(os.path.join(figDir,'mnv_depth_map_thresh_hva.'+figExt))
    fdepth_hist_hva.savefig(os.path.join(figDir,'mnv_depth_hist_hva.'+figExt))
...
if savefigs:
    f.savefig(os.path.join(figDir,'mnv_summary_errorbars.'+figExt))
...
if savefigs:
    f.savefig(os.path.join(figDir,'mnv_summary_violin.'+figExt))
...
if savefigs:
    f.savefig(os.path.join(figDir,'mnv_summary_violin_hva.'+figExt))
...
gPPIDetails_V1tgt = {'labels': ['V23_tgt', 
                          'V23_tgt_iso0',
                          'V23_tgt_iso90',
                          'V23_tgt_orth',
                          'V23_tgt_sur'],
...
gPPIDetails_V23tgt = {'labels': ['V1_tgt', 
                          'V1_tgt_iso0',
                          'V1_tgt_iso90',
                          'V1_tgt_orth',
                          'V1_tgt_sur'],
...
plot_centroids(all_data, masks_V1, gPPIDetails_V1tgt, roiRad, nDepths, xlim=[-5,5])
        
if savefigs:
    for l in gPPIDetails_V1tgt['labels']:
        plt.figure(l)
        plt.savefig(os.path.join(figDir,'centroids_%s.%s' %(l,figExt)))

Nsubj = len(hva_data.keys())

#plot centroids for each condition and ROI
plot_centroids(hva_data, masks_hva, gPPIDetails_V23tgt, roiRad, nDepths, xlim=[-5,5])
...
if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI.'+figExt))
...
xlim = [-0.2,0.7]
Ntext = [0.4,0.05]
plot_avg_depth_profile(p1,avgV1Profiles,['V23_tgt'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V23 -> V1')

p2 = fig.add_axes([.7, .2, .25, .7])
fix_axes(p2, lcolor=lcolor, fcolor=fcolor)
xlim = [-0.2,0.7]
plot_avg_depth_profile(p2,avgV23Profiles,['V1_tgt'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V1 -> V23')

if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt_combined.'+figExt))
...
xlim = [-0.2,0.7]
Ntext = [0.4,0.05]
plot_avg_depth_profile(p1,avgV1Profiles,['V23_tgt_iso0'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V23 -> V1 iso0')

p2 = fig.add_axes([.7, .2, .25, .7])
fix_axes(p2, lcolor=lcolor, fcolor=fcolor)
xlim = [-0.2,0.7]
plot_avg_depth_profile(p2,avgV23Profiles,['V1_tgt_iso0'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V1 -> V23 iso0')

if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt_iso0_combined.'+figExt))
...
xlim = [-0.2,0.7]
Ntext = [0.4,0.05]
plot_avg_depth_profile(p1,avgV1Profiles,['V23_tgt_iso90'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V23 -> V1 iso90')

p2 = fig.add_axes([.7, .2, .25, .7])
fix_axes(p2, lcolor=lcolor, fcolor=fcolor)
xlim = [-0.2,0.7]
plot_avg_depth_profile(p2,avgV23Profiles,['V1_tgt_iso90'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V1 -> V23 iso90')

if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt_iso90_combined.'+figExt))
...
xlim = [-0.2,0.7]
Ntext = [0.4,0.05]
plot_avg_depth_profile(p1,avgV1Profiles,['V23_tgt_orth'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V23 -> V1 orth')

p2 = fig.add_axes([.7, .2, .25, .7])
fix_axes(p2, lcolor=lcolor, fcolor=fcolor)
xlim = [-0.2,0.7]
plot_avg_depth_profile(p2,avgV23Profiles,['V1_tgt_orth'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V1 -> V23 orth')

if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt_orth_combined.'+figExt))
...
xlim = [-0.2,0.7]
Ntext = [0.4,0.05]
plot_avg_depth_profile(p1,avgV1Profiles,['V23_tgt_sur'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V23 -> V1 sur')

p2 = fig.add_axes([.7, .2, .25, .7])
fix_axes(p2, lcolor=lcolor, fcolor=fcolor)
xlim = [-0.2,0.7]
plot_avg_depth_profile(p2,avgV23Profiles,['V1_tgt_sur'],['blue'],ylim,xlim,dx,dy,Ntext,lcolor,fsize,showSig=True,statCorrType=statCorrType)
plt.title('V1 -> V23 sur')

if savefigs:
    fig.savefig(os.path.join(figDir,'avg_profiles_gPPI_V1tgt-V2tgt_sur_combined.'+figExt))